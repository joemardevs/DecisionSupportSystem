...
class Index extends Component
{
    ...
    public function export()
    {
        ...
        $research = Research::where('department_id', DepartmentEnum::CED->value)
            ...
            ->get();
        return Excel::download(new ResearchExport($research), 'CED Research.xlsx');
    }
    public function render()
    {
        $title = 'CED';
        $cedResearch = Research::orderBy('updated_at', 'desc')
            ->orderBy('id', 'desc')
