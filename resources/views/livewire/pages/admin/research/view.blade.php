            ...
            <div class="w-full p-4">
                ...
                <div class="bg-white relative drop-shadow sm:rounded-lg overflow-hidden">
                    <div class="w-full p-4 bg-white rounded-lg drop-shadow-md flex flex-col gap-4">
                        <h1 class="text-xl font-semibold">{{ $research->title }} success rate</h1>
                        <small class="text-gray-500">View the research success rate below.</small>
                        <div class="w-96 h-fit p-4">
                            <div class="mx-auto">
                                <canvas id="researchSuccessRate" style="height:5px; width:5px"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
