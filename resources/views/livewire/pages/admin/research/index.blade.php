                                ...
                                @forelse ($allResearch as $research)
                                    <tr wire:key="{{ $research->id }}" class="border-b">
                                        ...
                                        <td x-data="{ expanded: false }" class="px-4 py-3 flex items-center justify-start">
                                            ...
                                            <button type="button"
                                                wire:click="showDeleteConfirmationModal({{ $research->id }})"
                                                class="px-1 py-1 text-red-500 hover:underline underline-offset-2 rounded">
                                                Delele
                                            </button>
                                        </td>
                                    </tr>
    ...
    <div class="absolute top-0 left-0 flex items-center justify-center w-full h-full backdrop-blur-sm"
        ...
        <form wire:submit="deleteResearch({{ $selectedResearch->id ?? null }})"
            ...
            <div class="text-center">
                ...
                <div class="mt-2">
                    Are you sure you want to delete {{ $selectedResearch->title ?? '' }}?
                </div>
            </div>
