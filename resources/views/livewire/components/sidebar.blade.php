    ...
    <aside class="w-64 h-screen p-4 flex flex-col text-sm font-semibold sticky top-0"
        ...
        <div class="flex items-center justify-between w-44 absolute bottom-4 gap-2 my-2">
            ...
            <a href="{{ route('settings') }}"
                class="flex items-center gap-2 cursor-pointer {{ request()->is('settings') ? 'text-[#116736]' : 'text-[#3a4657] hover:text-[#116736]' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <p class="{{ request()->is('settings') ? 'text-[#116736]' : 'text-[#3a4657] hover:text-[#116736]' }}">
                    Settings</p>
            </a>
            {{-- Logout --}}
            <button wire:click="signout" class="cursor-pointer text-red-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
